# -*- coding: utf-8 -*-
"""
Created on Mon Jan 20 23:43:29 2020

@author: rodri
"""
def getCheatCodes(molname, cheatLevel):
#function cheatCodes = getCheatCodes(molname,cheatLevel)
    ...
    elif molname==  'betapinene':  #didn't work with original settings. scaffold has only 3.
    ...
    elif molname==  'ethylguiacol': #didn't work with original settings. scaffold has only 3.
    ...
    elif molname==  '../squareassign/Molecules/fakes/fakeMyrtenalac.csv':
...
def defaultCheatCodes():
	codes['correctf1'] = 0;
    codes['correctf2'] = 0;
    codes['forcef1'] = 0;
    codes['forcef2'] = 0;
    codes['cheatString'] = 'No cheats armed';
    codes['forceka'] = {};  # empty cell array in matlab, [] is  list and {} is a dict in py
